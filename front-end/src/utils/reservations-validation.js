...
export function validateForm(formData) {
  ...
  if (!validateDay(formData["reservation_date"], formData["reservation_time"])) {
    errors.push("Restaurant is closed on Tuesdays. Please select a different reservation date.");
  }

  // validate future date
  if (!validateFuture(formData["reservation_date"], formData["reservation_time"])) {
